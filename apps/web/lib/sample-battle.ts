...
export const SAMPLE_RECORD: BattleRecord = {
  ...
  spec: {
    ...
    evaluation: {
      ...
      efficiency: { weights: { tokens_total: 0.4, cost_usd: 0.35, duration_ms: 0.25 }, minAdvantage: 0.05 },
      judge: { enabled: false },
    },
  ...
  verdict: {
    ...
    breakdown: [
      { factor: 'completion', result: 'tie', detail: 'both sides completed' },
      { factor: 'tests', result: 'a', detail: 'side B had failing tests' },
    ],
    efficiency: { winner: 'n/a', advantage: 0, minAdvantage: 0.05, metrics: [], excluded: [] },
    judge: null,
  },
  insights: INSIGHTS,
